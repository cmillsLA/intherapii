...
/* Modified slotSegHtml() to print map lat/lng to data tag 08.01.13 */
/* Modified renderSection() to append add button to the right side 08.10.13 */
			...
			element = $("<table class='fc-header' style='width:100%'/>")
				.append(
					$("<tr/>")
						...
						.append('<td class="fc-header-right"><button class="btn btn-primary dBlock right" id="addCalendarAppt">Add Appointment</button></td>')
				);
			return element;
		}
	}
...
function AgendaEventRenderer() {
	...
	// Modified function to pass lat/lng for map popups
	function slotSegHtml(event, seg) {
		...
		html +=
			...
			// Custom latitude and longitude for popup map
			if(event.lat && event.lng) {
				html += '<div class="mapLink" data-lat="' + event.lat + '" data-lng="' + event.lng + '">Map Link</div>';
			}
			html += "</div>" +
